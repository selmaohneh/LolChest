...
namespace LolChest.Tests
{
    ...
    public class YearlyReportTests
    {
        ...
        public async Task TestYearlyReport()
        {
            ...
            SummonerResult summonerResult3 = SummonerResultTestFactory.CreateSummonerResult("Cello", 63, true, "3", 13,15,8, 15, 2021, 7, 6, EFirstBloodParticipation.NotYetTracked);
