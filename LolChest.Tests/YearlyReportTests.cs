...
namespace LolChest.Tests
{
    ...
    public class YearlyReportTests
    {
        ...
        public async Task TestYearlyReport()
        {
            ...
            SummonerResult summonerResult7 = SummonerResultTestFactory.CreateSummonerResult("Benni", 9, true, "1", 5,5,24, 39, 2021, 9, 24, EFirstBloodParticipation.NoParticipation);
            SummonerResult summonerResult8 = SummonerResultTestFactory.CreateSummonerResult("Benni", 8, false, "2", 0,0,11, 42, 2021, 7, 12, EFirstBloodParticipation.NoParticipation);
