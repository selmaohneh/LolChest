...
namespace LolChest.Tests
{
    ...
    public class YearlyReportTests
    {
        ...
        public async Task TestYearlyReport()
        {
            ...
            SummonerResult summonerResult3 = SummonerResultTestFactory.CreateSummonerResult("Cello", 62, true, "3", 13,15,8, 15, 2021, 7, 6, EFirstBloodParticipation.NotYetTracked);
            ...
            SummonerResult summonerResult7 = SummonerResultTestFactory.CreateSummonerResult("Whizzy", 62, true, "4", 4,0,15, 15, 2021, 7, 6, EFirstBloodParticipation.NoParticipation);
            SummonerResult summonerResult8 = SummonerResultTestFactory.CreateSummonerResult("Benni", 9, true, "1", 5,5,41, 39, 2021, 9, 24, EFirstBloodParticipation.NoParticipation);
